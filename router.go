...
// Params is a map of name/value pairs for named routes. An instance of core.Params is available to be injected into any route handler.
type Params map[string]string

// Router is Core's de-facto routing interface. Supports HTTP verbs, stacked handlers, and dependency injection.
type Router interface {
	...
	// Handle is the entry point for routing. This is used as a core.Handler
...
// If you aren't using ClassicCore, then you can add Routes as a
// service with:
//
//	m := core.New()
//	r := core.NewRouter()
//	m.MapTo(r, (*core.Routes)(nil))
//
// If you are using ClassicCore, then this is done for you.
...
// Route is an interface representing a Route in Core's routing layer.
...
// Routes is a helper service for Core's routing layer.
