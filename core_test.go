...
func Test_New(t *testing.T) {
	m := New()
	if m == nil {
		t.Error("core.New() cannot return nil")
	}
}

func Test_Core_RunOnAddr(t *testing.T) {
...
func Test_Core_ServeHTTP(t *testing.T) {
	result := ""
...
func Test_Core_Handlers(t *testing.T) {
	result := ""
	response := httptest.NewRecorder()
...
func Test_Core_EarlyWrite(t *testing.T) {
	result := ""
	response := httptest.NewRecorder()
...
func Test_Core_Written(t *testing.T) {
	response := httptest.NewRecorder()
...
func Test_Core_Basic_NoRace(t *testing.T) {
	m := New()
